...
public class basketball{
	...
	//	options.addArguments("--start-maximized");
		...
		String baseUrl2 = "https://swishanalytics.com/optimus/nba/fanduel-draftkings-live-scoring";
		driver.get(baseUrl2);
		driver.manage().window().maximize();
		
		Thread.sleep(9000);

		List<WebElement> rows = driver.findElements(By.xpath("/html/body/div[3]/div[2]/div/div[6]/div/div[4]/div/table/tbody/tr/td[1]"));
